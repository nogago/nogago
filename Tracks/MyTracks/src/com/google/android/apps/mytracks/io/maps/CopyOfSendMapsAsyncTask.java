...
import com.nogago.android.tracks.SendMapsActivity;
 ...
 * @author Jimmy Shih
 */
public class CopyOfSendMapsAsyncTask extends AbstractSendAsyncTask {
  ...
  private static final String TAG = CopyOfSendMapsAsyncTask.class.getSimpleName();
  ...
  public CopyOfSendMapsAsyncTask(SendMapsActivity activity, long trackId, Account account,
      String chooseMapId) {
   ...
   */
  @VisibleForTesting
  public CopyOfSendMapsAsyncTask (
  ...
  /**
   * Fetches the {@link CopyOfSendMapsAsyncTask#mapId} instance variable for
