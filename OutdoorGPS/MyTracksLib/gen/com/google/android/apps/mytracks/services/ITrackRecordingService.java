 ...
 * Original file: /Users/raphaelvolz/Documents/GitHub/nogago/OutdoorGPS/MyTracksLib/src/com/google/android/apps/mytracks/services/ITrackRecordingService.aidl
 */
...
{
data.enforceInterface(DESCRIPTOR);
com.nogago.android.apps.tracks.content.WaypointCreationRequest _arg0;
if ((0!=data.readInt())) {
_arg0 = com.nogago.android.apps.tracks.content.WaypointCreationRequest.CREATOR.createFromParcel(data);
}
else {
_arg0 = null;
}
...
/**
   ...
   */
@Override public long insertWaypoint(com.nogago.android.apps.tracks.content.WaypointCreationRequest request) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
long _result;
...
/**
   ...
   * @return the ID of the inserted waypoint
   */
public long insertWaypoint(com.nogago.android.apps.tracks.content.WaypointCreationRequest request) throws android.os.RemoteException;
/**
   * Inserts a track point in the current recording track.
   *
   * When recording a track, GPS locations are automatically inserted. This is used for
