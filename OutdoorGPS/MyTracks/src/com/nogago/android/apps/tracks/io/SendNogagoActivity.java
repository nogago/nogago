 ...
 * @author Jimmy Shih
 */
public class SendNogagoActivity extends AbstractSendActivity {

  @Override
  protected AbstractSendAsyncTask createAsyncTask() {
    return new SendNogagoAsyncTask(this, sendRequest.getTrackId(), 
        sendRequest.getMapId());
  }

  @Override
  protected String getServiceName() {
    return getString(R.string.send_nogago_title);
  }

  @Override
  protected void startNextActivity(boolean success, boolean isCancel) {
    sendRequest.setNogagoSuccess(success);
